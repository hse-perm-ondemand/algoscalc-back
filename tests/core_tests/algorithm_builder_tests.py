...
from src.core.algorithm_builder import (
...
class AlgorithmBuilderTest(unittest.TestCase):
    ...
    def test_non_string_definition(self):
        ...
        self.assertEqual(
            NON_STRING_PARAM_TEMPL.format("definition_file_name"), str(error.exception)
        )
    ...
    def test_non_string_function(self):
        ...
        self.assertEqual(
            NON_STRING_PARAM_TEMPL.format("function_file_name"), str(error.exception)
        )
    ...
    def test_empty_function(self):
        ...
        self.assertEqual(
            EMPTY_STRING_PARAM_TEMPL.format("function_file_name"), str(error.exception)
        )
    ...
    def test_non_string_test(self):
        ...
        self.assertEqual(
            NON_STRING_PARAM_TEMPL.format("test_file_name"), str(error.exception)
        )
    ...
    def test_empty_test(self):
        ...
        self.assertEqual(
            EMPTY_STRING_PARAM_TEMPL.format("test_file_name"), str(error.exception)
        )
    ...
    def test_non_string_schema(self):
        ...
        self.assertEqual(
            NON_STRING_PARAM_TEMPL.format("schema_file_path"), str(error.exception)
        )
    ...
    def test_empty_schema(self):
        ...
        self.assertEqual(
            EMPTY_STRING_PARAM_TEMPL.format("schema_file_path"), str(error.exception)
        )
    ...
    def test_build_wrong_def(self):
        ...
        self.write_file(FUNCTION_FILE_NAME, FIB_FUNC)
        self.write_file(TEST_FILE_NAME, FIB_TESTS)
        self.assertRaises(ValidationError, self.builder.build_algorithm, FOLDER_PATH)
    ...
    def test_build_missing_def(self):
        self.write_file(FUNCTION_FILE_NAME, FIB_FUNC)
        self.write_file(TEST_FILE_NAME, FIB_TESTS)
        self.assertRaises(FileNotFoundError, self.builder.build_algorithm, FOLDER_PATH)
