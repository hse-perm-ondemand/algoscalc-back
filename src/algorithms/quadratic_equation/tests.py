...
class TestCase(unittest.TestCase):
    ...
    def test_zero_discriminant(self):
            self.assertEqual(quadratic_equation(1, 10, 25), 'Корень только один: x = -5.0')

    def test_zero_a_coefficient(self):
            self.assertEqual(quadratic_equation(0, 5, 1), 'Коэффицент при х^2 в квадратном уравнении не может быть равен 0!')
    ...
    def test_periodic_fraction_coefficient(self):
            self.assertEqual(quadratic_equation(1/3, 5/7, -3), 'x1 = 2.11415759, x2 = -4.25701473')
