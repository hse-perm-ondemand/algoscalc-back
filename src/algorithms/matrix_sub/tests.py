...
class TestCase(unittest.TestCase):
    ...
    def test_dlina(self):
        n = [[0.0], [1.0]]
        m = [[0.0], [0.0], [0.0]]
        self.assertRaisesRegex(ValueError, "Длины матриц не совпадают!", main, n, m)

    def test_row(self):
        n = [[None], [1.0]]
        m = [[0.0], [0.0]]
        self.assertRaisesRegex(
            ValueError, "Не введено значение в матрице n", main, n, m
        )
    ...
    def test_rows(self):
        ...
        m = [[None], [1.0]]
        self.assertRaisesRegex(
            ValueError, "Не введено значение в матрице m", main, n, m
        )
