...
class TestCase(unittest.TestCase):
    ...
    def test_single_true(self):
        self.assertEqual({HAS_PERFECT: True, PERFECT_NUMBERS: [6]}, main([6]))

    def test_single_false(self):
        self.assertEqual({HAS_PERFECT: False, PERFECT_NUMBERS: []}, main([5]))

    def test_multi_true(self):
        self.assertEqual({HAS_PERFECT: True, PERFECT_NUMBERS: [6]}, main([0, 1, 6]))

    def test_multi_perfect_only(self):
        self.assertEqual(
            {HAS_PERFECT: True, PERFECT_NUMBERS: [6, 28, 496, 8128]},
            main([6, 28, 496, 8128]),
        )
